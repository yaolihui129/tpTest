<?php
class StagetesterAction extends CommonAction {
...
//         dump($_GET);
    ...
    public function mod(){
        ...
        $this->assign("startDate",PublicAction::date("start",$tester['start']));
        $this->assign("endDate",PublicAction::date("end",$tester['end']));
        $this->assign('w',$where);
        $this->display();
